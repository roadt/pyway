...
print( config.get('Section1', 'foo', raw=0) )# -> "Python is fun!"
print( config.get('Section1', 'foo', raw=1)) # -> "%(bar)s is %(baz)s!"

# The optional fourth argument is a dict with members that will take
# precedence in interpolation.
print(config.get('Section1', 'foo', raw=0, vars={'bar': 'Documentation', 'baz': 'evil'}))
